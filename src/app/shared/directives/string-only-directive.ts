...
export class StringOnlyDirective {
      ...
      @HostListener('paste', ['$event']) onKeyPaste(e: ClipboardEvent): boolean {
        console.log(e);

        // Perform a null check on e.clipboardData
        if (e.clipboardData) {
        ...
        // If e.clipboardData is null, you might want to handle it accordingly
